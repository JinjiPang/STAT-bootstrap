...
set.seed(2022)
simdata1 <- lapply(1:2000, function(i) {
...
simdata2 <- lapply(1:2000, function(i) {
...
simdata3 <- lapply(1:2000, function(i) {
...
simdata4 <- lapply(1:2000, function(i) {
...
simdata5 <- lapply(1:2000, function(i) {
...
simdata6 <- lapply(1:2000, function(i) {
